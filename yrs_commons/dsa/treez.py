...
class BinaryTree:
    """
    +---------------------+---------------------------------------+-----------------------------+--------------------------------------------+
    | Traversal Type       | Order of Visit                        | Time Complexity              | Child Positioning                          |
    +=====================+=======================================+=============================+============================================+
    | **In-Order (DFS)**   | Left → Root → Right                   | O(n)                         | Binary Tree:                               |
    |                     |                                       |                             | - Left: `2 * index + 1`                    |
    |                     |                                       |                             | - Right: `2 * index + 2`                   |
    +---------------------+---------------------------------------+-----------------------------+--------------------------------------------+
    | **Pre-Order (DFS)**  | Root → Left → Right                   | O(n)                         | Binary Tree:                               |
    |                     |                                       |                             | - Left: `2 * index + 1`                    |
    |                     |                                       |                             | - Right: `2 * index + 2`                   |
    +---------------------+---------------------------------------+-----------------------------+--------------------------------------------+
    | **Post-Order (DFS)** | Left → Right → Root                   | O(n)                         | Binary Tree:                               |
    |                     |                                       |                             | - Left: `2 * index + 1`                    |
    |                     |                                       |                             | - Right: `2 * index + 2`                   |
    +---------------------+---------------------------------------+-----------------------------+--------------------------------------------+
    | **Level-Order (BFS)**| Level by level                        | O(n)                         | Queue-based traversal                      |
    +---------------------+---------------------------------------+-----------------------------+--------------------------------------------+
    | **N-ary Pre-Order**  | Root → Children (left to right)       | O(n)                         | N-ary Tree:                                |
    |                     |                                       |                             | - Child at position `k`:                   |
    |                     |                                       |                             |   `N * index + k + 1`                      |
    +---------------------+---------------------------------------+-----------------------------+--------------------------------------------+
    | **N-ary Post-Order** | Children → Root                       | O(n)                         | N-ary Tree:                                |
    |                     |                                       |                             | - Child at position `k`:                   |
    |                     |                                       |                             |   `N * index + k + 1`                      |
    +---------------------+---------------------------------------+-----------------------------+--------------------------------------------+
